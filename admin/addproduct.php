                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-md-1  col-md-9 col-sm-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-7">
                                    <input type="text" class="form-control" id="basic-url"
                                        aria-describedby="basic-addon3" name="food_name"
                                        placeholder="Enter name of food" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3 col-sm-5 my-auto">
                                ...
                                <div class="col-md-9 col-sm-7">
                                    <input type="text" class="form-control" id="basic-url2"
                                        aria-describedby="basic-addon3" name="food_desc" placehold
                                        er="Enter food description" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-7">
                                    <input type="number" pattern="[0-9]{1,}" min="50" class="form-control" id="i4"
                                        aria-describedby="basic-addon3" name="food_price" placeholder="Enter food price"
                                        required>
                                </div>
                            </div>
                        </div>
